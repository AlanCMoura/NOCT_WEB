    ...
    <div className="flex min-h-screen bg-app md:h-screen">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="border-b border-[var(--border)] bg-[var(--surface)]">
          <div className="flex min-h-20 flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center justify-between gap-4 sm:justify-end">
              <div onClick={() => changePage('perfil')} className="hidden min-w-0 items-center gap-3 rounded-lg px-2 py-2 transition-colors hover:bg-[var(--hover)] md:flex md:px-4">
        ...
        <main className="flex-1 overflow-auto p-4 sm:p-6">
          <div className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-end">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:flex xl:flex-wrap xl:items-center">
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center rounded-lg bg-[var(--primary)] px-4 py-2.5 text-sm font-medium text-[var(--on-primary)] transition-colors hover:opacity-90 disabled:opacity-60 sm:w-auto"
                disabled={loading}
              >
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 py-2.5 text-sm font-medium text-[var(--text)] transition-colors hover:bg-[var(--hover)] disabled:opacity-60 sm:w-auto"
                disabled={importing}
              ...
              <button onClick={handleNew} className="inline-flex w-full items-center justify-center rounded-lg bg-[var(--primary)] px-4 py-2.5 text-sm font-medium text-[var(--on-primary)] transition-colors hover:opacity-90 sm:w-auto">
          ...
          {hasImportFeedback && (
            <div className="mb-4 flex flex-col gap-3 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-4 text-sm sm:flex-row sm:items-start sm:justify-between">
              <div>
          ...
          <div className="bg-[var(--surface)] rounded-xl shadow-sm border border-[var(--border)]">
            {loading ? (
              ...
              <>
                ...
                {filtered.map((op) => (
                  <article key={op.id || op.ctv} className="space-y-4 p-4">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="text-xs uppercase tracking-wider text-[var(--muted)]">CTV</p>
                        <p className="truncate text-base font-semibold text-[var(--text)]">{op.ctv || op.id}</p>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div className="min-w-0">
                        <p className="text-xs uppercase tracking-wider text-[var(--muted)]">Reserva</p>
                        <p className="truncate text-[var(--text)]">{op.reserva || '---'}</p>
                      </div>
                      <div className="min-w-0">
                        <p className="text-xs uppercase tracking-wider text-[var(--muted)]">Containers</p>
                        <p className="text-[var(--text)]">{op.containerCount !== undefined ? op.containerCount : '...'}</p>
                      </div>
                      <div className="col-span-2 min-w-0">
                        <p className="text-xs uppercase tracking-wider text-[var(--muted)]">Navio</p>
                        <p className="truncate text-[var(--text)]">{op.shipName}</p>
                      </div>
                      <div className="col-span-2 min-w-0">
                        <p className="text-xs uppercase tracking-wider text-[var(--muted)]">Data</p>
                        <p className="text-[var(--text)]">{formatDate(op.date)}</p>
                      </div>
                    </div>

                    <button
                      onClick={() => handleView(op.id || op.ctv)}
                      className="inline-flex w-full items-center justify-center rounded-lg border border-teal-200 px-4 py-2.5 text-sm font-medium text-teal-700 transition-colors hover:bg-teal-50"
                    >
                      Ver detalhes
                    </button>
                  </article>
            ...
            <div className="border-t border-[var(--border)] px-4 py-4 sm:px-6">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                  <label className="flex items-center justify-between gap-2 text-sm text-[var(--muted)] sm:justify-start">
        ...
        {showImportModal && (
          <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
            ...
            <div className="relative max-h-[90vh] w-full overflow-auto rounded-t-2xl border border-[var(--border)] bg-[var(--surface)] p-4 shadow-2xl space-y-4 sm:mx-4 sm:max-w-2xl sm:rounded-2xl sm:p-6">
              ...
              <div className="flex flex-col gap-3 rounded-lg bg-[var(--hover)] p-3 text-sm sm:flex-row sm:items-center sm:justify-between">
                <div>
              ...
              <div className="flex justify-end">
                <button
                  type="button"
                  onClick={startImport}
                  className="inline-flex w-full items-center justify-center rounded-lg bg-[var(--primary)] px-4 py-2 text-sm font-semibold text-[var(--on-primary)] transition-colors hover:opacity-90 disabled:opacity-60 sm:w-auto"
