...
const Dashboard: React.FC = () => {
  ...
  const handlePageChange = (pageId: string): void => {
    switch (pageId) {
      ...
      case "perfil": navigate("/profile"); break;
      case "usuarios": navigate("/users"); break;
      case "relatorios": navigate("/reports"); break;
      case "logout": localStorage.removeItem("token"); localStorage.removeItem("user"); navigate("/login"); break;
      default: break;
    }
  };
